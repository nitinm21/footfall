...
CREATE TABLE "fixes" (
	...
	"path" text NOT NULL,
	"type" text NOT NULL,
	"marked_deployed_at" timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE "fixes" ADD CONSTRAINT "fixes_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "fixes_site_path_uq" ON "fixes" USING btree ("site_id","path");